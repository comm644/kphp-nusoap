...
class nusoap_wsdlcache
{
	 ...
	 * @access public
	 */
	public function get(string $wsdl)
	{
	 ...
	 *
	 * @param nusoap_wsdl $wsdl_instance The wsdl instance to add
	 * @return bool WSDL successfully cached
	 * @access public
	 */
	public function put(nusoap_wsdl $wsdl_instance)
	{
	 ...
	 * @access public
	 */
	public function remove(string $wsdl)
	{
		$filename = $this->createFilename($wsdl);
		if (!file_exists($filename)) {
